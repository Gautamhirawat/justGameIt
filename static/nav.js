...
<nav class="navbar">
        <ul class="navbar__menu">
          ...
          <li class="navbar__item">
            <a href="#" class="navbar__link"><i data-feather="message-square"></i><span>Notification</span></a>        
          </li>
          <li class="navbar__item">
            <a href="#" class="navbar__link"><i data-feather="users"></i><span>Login</span></a>        
          </li>
          <li class="navbar__item">
            <a href="https://github.com/Gautamhirawat/justGameIt.github.io/blob/main/games.html" class="navbar__link"><i data-feather="play"></i><span>Games</span></a>        
          </li>
          <li class="navbar__item">
